...
import styles from "@/pages/products-vendor/pages/mobileTablets/NewMobileTablets.module.scss";
          ...
          <div className={styles.inputRadioBox}>
            ...
            <div className={styles.radioInputs}>
              <div className={styles.inputRadio}>
                <input onChange={productToSellIs.onChange} value='New' type="radio"/>
                <label>New</label>
              </div>
              <div className={styles.inputRadio}>
                <input onChange={productToSellIs.onChange} value='Used' type="radio"/>
                <label>Used</label>
              </div>
            </div>
          </div>
          <div className={styles.packageDetails}>
            ...
            <div className={styles.inputsCheckbox}>
              <div className={styles.inputCheckbox}>
                <div>
                  <input onChange={() => setIsFullPrice((prev: boolean) => !prev)} value={price.value} type="checkbox"/>
