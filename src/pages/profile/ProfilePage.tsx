    ...
    <div className={'max-w-[1240px] px-[20px] justify-between flex gap-[50px] mx-auto pt-[90px] pb-[160px]'}>
        <div className={'w-[360px]'}>
          <div className={'w-full h-full bg-white drop-shadow-lg'}>
            <div onClick={() => setSelectedLabel('Profile')} className={selectedLabel === t('Profile') ? 'flex gap-4 items-center bg-gray-100 bg-opacity-80 cursor-pointer py-[20px] px-[30px]' : 'flex gap-4 items-center hover:bg-[#E9E9E9] cursor-pointer py-[20px] px-[30px]'}>
            ...
            <div onClick={() => setSelectedLabel('Address')} className={selectedLabel === t('Address') ? 'flex gap-4 items-center bg-gray-100 bg-opacity-80 cursor-pointer py-[20px] px-[30px]' : 'flex gap-4 items-center hover:bg-[#E9E9E9] cursor-pointer py-[20px] px-[30px]'}>
              <div className={'w-[20px]'}>
            ...
            {user.role === 'Buyer' && <div onClick={() => setSelectedLabel('My Orders')} className={selectedLabel === t('My Orders') ? 'flex gap-4 items-center bg-gray-100 bg-opacity-80 cursor-pointer py-[20px] px-[30px]' : 'flex gap-4 items-center hover:bg-[#E9E9E9] cursor-pointer py-[20px] px-[30px]'}>
              <div className={'w-[20px]'}>
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <div onClick={() => setSelectedLabel('Change Password')} className={selectedLabel === t('Change Password') ? 'flex gap-4 items-center bg-gray-100 bg-opacity-80 cursor-pointer py-[20px] px-[30px]' : 'flex gap-4 items-center hover:bg-[#E9E9E9] cursor-pointer py-[20px] px-[30px]'}>
              <div className={'w-[20px]'}>
            ...
            <div onClick={() => navigate('/terms-and-conditions')} className={'flex gap-4 items-center hover:bg-[#E9E9E9] cursor-pointer py-[20px] px-[30px]'}>
              <div className={'w-[20px]'}>
            ...
            <div onClick={() => navigate('/contact-us')} className={'flex gap-4 items-center hover:bg-[#E9E9E9] cursor-pointer py-[20px] px-[30px]'}>
              <div className={'w-[20px]'}>
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <div onClick={logoutHandler} className={'flex gap-4 items-center hover:bg-[#E9E9E9] cursor-pointer py-[20px] px-[30px]'}>
              <div className={'w-[20px]'}>
