...
export const PhotoAndVideoBlock = ({ title, subtitle, setStage, setFormData, formData }: PhotoAndVideoBlockProps) => {
  ...
  return (
    <Layout stage={4} subtitle={subtitle} title={title} setStage={setStage}>
