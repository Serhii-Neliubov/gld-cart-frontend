            ...
            <div className={styles.inputsRadio}>
              ...
              <div className={styles.radioInputs}>
                <div className={styles.inputRadio}>
                  <input value='Branded' name='productWantToSell' onChange={productToSellIs.onChange} type="radio"/>
                  <label>Branded</label>
                </div>
                <div className={styles.inputRadio}>
                  <input value='Local' name='productWantToSell' onChange={productToSellIs.onChange} type="radio"/>
                  <label>Local</label>
                </div>
              </div>
            </div>
