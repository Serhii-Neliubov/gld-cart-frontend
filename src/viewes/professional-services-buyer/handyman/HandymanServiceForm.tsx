...
import styles from "./HandymanServiceForm.module.scss";
import { Link } from "react-router-dom";

const HandymanServiceForm: FC = () => {
  return (
    <div style={{ paddingBottom: "50px" }} className="__container">
      ...
      <div className={styles.actions}>
        ...
        <Link to="/personal-services/handyman/photo-and-video">
          <button
            style={{
...
export default HandymanServiceForm;
