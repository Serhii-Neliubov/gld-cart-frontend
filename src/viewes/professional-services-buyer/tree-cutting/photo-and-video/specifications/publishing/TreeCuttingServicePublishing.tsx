...
import styles from "./TreeCuttingServicePublishing.module.scss";
import { Link } from "react-router-dom";

const TreeCuttingServicePublishing: FC = () => {
  return (
    <div
      style={{
        paddingBottom: "300px",
    ...
    >
      ...
      <div className={styles.content}>
        ...
        <h1 className={styles.title}>
          Your Gardening Renting Form has <br /> been Successfully Completed
        </h1>
...
export default TreeCuttingServicePublishing;
