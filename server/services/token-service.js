...
var TokenService = /** @class */ (function () {
    ...
    TokenService.prototype.createTokens = function (payload) {
    ...
    TokenService.prototype.saveToken = function (userId, refreshToken) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Token_1.default.findOne({ user: userId })];
                    case 1:
                        tokenData = _a.sent();
                        if (tokenData) {
                        ...
                        return [4 /*yield*/, Token_1.default.create({ user: userId, refreshToken: refreshToken })];
    ...
    TokenService.prototype.removeToken = function (refreshToken) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Token_1.default.deleteOne({ refreshToken: refreshToken })];
            });
        });
    };
    TokenService.prototype.findToken = function (refreshToken) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Token_1.default.findOne({ refreshToken: refreshToken })];
            });
        });
    };
