...
var ChatService = /** @class */ (function () {
    ...
    ChatService.prototype.createMessage = function (text, sender, recipient) {
        return __awaiter(this, void 0, void 0, function () {
            var newMessage;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.all([Message_1.default.create({
                                text: text,
                                sender: sender,
                                receiver: recipient,
                            })])];
    ...
    ChatService.prototype.getAllMessages = function (sender, recipient) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, typedMessages.map(function (msg) { return ({
