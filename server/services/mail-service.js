...
var MailService = /** @class */ (function () {
    ...
    MailService.prototype.sendContactMail = function (name, email, subject, message, to) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.transporter.sendMail({
                                ...
                                to: to,
                                subject: subject,
                                text: "My name is: ".concat(name, ". My email is: ").concat(email, ". ").concat(message),
                            })];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
    ...
    MailService.prototype.sendResetPasswordMail = function (email, link) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
