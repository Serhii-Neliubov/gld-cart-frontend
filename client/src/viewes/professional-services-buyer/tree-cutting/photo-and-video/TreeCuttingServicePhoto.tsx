...
import styles from "./TreeCuttingServicePhoto.module.scss";
import { Link } from "react-router-dom";

const TreeCuttingServicePhoto: FC = () => {
  return (
    <div style={{ paddingBottom: "50px" }} className="__container">
      ...
      <div className={styles.actions}>
        ...
        <Link to="/renting-category-page/tree-cutting/photo-and-video/specifications">
          <button
            style={{
...
export default TreeCuttingServicePhoto;
