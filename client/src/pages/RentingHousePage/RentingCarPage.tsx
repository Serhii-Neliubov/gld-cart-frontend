            ...
            <div className={styles.items}>
              <div className={styles.item}>
                <div className={styles.image}>
                  <img src="RentingHousePage/image1.png" alt="Image" />
                </div>
                <div className={styles.item_text}>
                  <h2 className={styles.item_title}>8 Room big House</h2>
              ...
              <div className={styles.item}>
                <div className={styles.image}>
                  <img src="RentingHousePage/image2.png" alt="Image" />
                </div>
                <div className={styles.item_text}>
                  <h2 className={styles.item_title}>2 Room house</h2>
                  <div className={styles.item_prices}>
                    <div className={styles.item_price}>$180/Day</div>
                    <div className={styles.item_price}>$925/Week</div>
                    <div className={styles.item_price}>$3,100/Month</div>
              ...
              <div className={styles.item}>
                <div className={styles.image}>
                  <img src="RentingHousePage/image3.png" alt="Image" />
                </div>
                <div className={styles.item_text}>
                  <h2 className={styles.item_title}>Family Size house</h2>
                  <div className={styles.item_prices}>
                    <div className={styles.item_price}>$180/Day</div>
                    <div className={styles.item_price}>$925/Week</div>
                    <div className={styles.item_price}>$3,100/Month</div>
              ...
              <div className={styles.item}>
                <div className={styles.image}>
                  <img src="RentingHousePage/image4.png" alt="Image" />
                </div>
                <div className={styles.item_text}>
                  <h2 className={styles.item_title}>Farm house</h2>
                  <div className={styles.item_prices}>
                    <div className={styles.item_price}>$180/Day</div>
                    <div className={styles.item_price}>$925/Week</div>
                    <div className={styles.item_price}>$3,100/Month</div>
...
export default RentingHousePage;
