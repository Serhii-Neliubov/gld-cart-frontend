...
import styles from "./CleaningServiceForm.module.scss";
import { Link } from "react-router-dom";

const CleaningServiceForm: FC = () => {
  return (
    <div style={{ paddingBottom: "50px" }} className="__container">
      ...
      <h1 className={styles.title}>Cleaning SERVICES Form </h1>
      ...
      <div className={styles.actions}>
        ...
        <Link to="/personal-services/cleaning/photo-and-video">
          <button
            style={{
