...
import styles from "./GardeningServicePublishing.module.scss";
import { Link } from "react-router-dom";

const GardeningServicePublishing: FC = () => {
  return (
    <div
      style={{
        paddingBottom: "300px",
    ...
    >
      ...
      <div className={styles.content}>
        ...
        <h1 className={styles.title}>
          Your Tree Cutting Renting Form has <br /> been Successfully Completed
        </h1>
...
export default GardeningServicePublishing;
