...
import styles from "./LawnServicePublishing.module.scss";
import { Link } from "react-router-dom";

const LawnServicePublishing: FC = () => {
  return (
    <div
      style={{
        paddingBottom: "300px",
    ...
    >
      ...
      <div className={styles.content}>
        ...
        <h1 className={styles.title}>
          Your Law Renting Form has <br /> been Successfully Completed
        </h1>
...
export default LawnServicePublishing;
