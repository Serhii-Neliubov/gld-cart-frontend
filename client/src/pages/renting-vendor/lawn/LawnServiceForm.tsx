...
import styles from "./LawnServiceForm.module.scss";
import { Link } from "react-router-dom";

const LawnServiceForm: FC = () => {
  return (
    <div style={{ paddingBottom: "50px" }} className="__container">
      ...
      <h1 className={styles.title}>Lawn SERVICES Form </h1>
      <div className={styles.content}>
        ...
        <div className={styles.content_input_radio}>
          <span style={{ fontWeight: 600 }}>
            You want to give your Lawn service Per
          </span>
          ...
          <div style={{ marginTop: "35px" }}>
            <div style={{ display: "flex", gap: "100px" }}>
              <div style={{ display: "flex", gap: "10px" }}>
                ...
                <span style={{ fontWeight: "600" }}>
                  Lawn service Packages For Hour
                </span>
              </div>
              <div style={{ display: "flex", gap: "10px" }}>
                <input style={{ width: "20px" }} type="checkbox" />
                <span style={{ fontWeight: "600" }}>
                  Lawn service Packages For Day
                </span>
              </div>
              <div style={{ display: "flex", gap: "10px" }}>
                <input style={{ width: "20px" }} type="checkbox" />
                <span style={{ fontWeight: "600" }}>
                  Lawn service Packages For Week
                </span>
              </div>
            </div>
            <div
      ...
      <div className={styles.actions}>
        ...
        <Link to="/personal-services/lawn/photo-and-video">
          <button
            style={{
...
export default LawnServiceForm;
