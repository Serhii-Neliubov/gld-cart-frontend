...
import styles from "./ElectronicsRentingPhoto.module.scss";
import { Link } from "react-router-dom";

const ElectronicsRentingPhoto: FC = () => {
  return (
    <div style={{ paddingBottom: "50px" }} className="__container">
      ...
      <div className={styles.actions}>
        ...
        <Link to="/renting-category-page/electronics/photo-and-video/specifications">
          <button
            style={{
...
export default ElectronicsRentingPhoto;
