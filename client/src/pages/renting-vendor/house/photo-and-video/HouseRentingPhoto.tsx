...
import styles from "./HouseRentingPhoto.module.scss";
import { Link } from "react-router-dom";

const HouseRentingPhoto: FC = () => {
  return (
    <div style={{ paddingBottom: "50px" }} className="__container">
      ...
      <div className={styles.actions}>
        ...
        <Link to="/renting-category-page/houses/photo-and-video/specifications">
          <button
            style={{
...
export default HouseRentingPhoto;
