...
import styles from "./HouseRentingForm.module.scss";
import { Link } from "react-router-dom";

const HouseRentingForm: FC = () => {
  return (
    <div style={{ paddingBottom: "50px" }} className="__container">
      ...
      <div className={styles.actions}>
        ...
        <Link to="/renting-category-page/houses/photo-and-video">
          <button
            style={{
...
export default HouseRentingForm;
