...
export const PhotoAndVideoVehicle = () => {
    return (
        <Layout title='Vehicle Renting Form' subtitle='Photo and video' nextLink='/renting-category-page/vehicle/basic-information/photo-and-video/specifications' backLink='/renting-category-page/vehicle/basic-information' stage={3}>
