...
import styles from "./CleaningServicePhoto.module.scss";
import { Link } from "react-router-dom";

const CleaningServicePhoto: FC = () => {
  return (
    <div style={{ paddingBottom: "50px" }} className="__container">
      ...
      <div className={styles.actions}>
        ...
        <Link to="/personal-services/cleaning/photo-and-video/specifications">
          <button
            style={{
...
export default CleaningServicePhoto;
