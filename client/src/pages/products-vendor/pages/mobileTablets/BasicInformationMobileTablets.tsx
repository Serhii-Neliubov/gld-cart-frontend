...
import styles from './BasicInformationMobileTablets.module.scss'
import {Layout} from "../../../../components/Vendor/Layout.tsx";

export const BasicInformationMobileTablets = () => {
    return(
        <Layout title='Mobile Tablets PRODUCTS Form' subtitle='Basic information' stage={2}
                backLink='/products-category-page'
                nextLink='/products-category-page/mobile-tablets/basic-information/photo-and-video'>
