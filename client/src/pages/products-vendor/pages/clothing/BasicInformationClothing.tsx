...
import styles from './BasicInformationClothing.module.scss'
import {Layout} from "../../../../components/Vendor/Layout.tsx";

export const BasicInformationClothing = () => {
    return(
        <Layout title='Clothing PRODUCTS Form' subtitle='Basic information' stage={2}
                backLink='/products-category-page'
                nextLink='/products-category-page/clothing/basic-information/photo-and-video'>
