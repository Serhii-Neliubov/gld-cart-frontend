...
import styles from './BasicInformationCpu.module.scss'
import {Layout} from "../../../../components/Vendor/Layout.tsx";

export const BasicInformationCpu = () => {
    return(
        <Layout title='CPU PRODUCTS Form' subtitle='Basic information' stage={2} backLink='/products-category-page'
                nextLink='/products-category-page/cpu/basic-information/photo-and-video'>
