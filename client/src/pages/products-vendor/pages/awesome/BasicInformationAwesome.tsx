...
import styles from './BasicInformationAwesome.module.scss'
import {Layout} from "../../../../components/Vendor/Layout.tsx";

export const BasicInformationAwesome = () => {
    return(
        <Layout title='Awesome Lip Care PRODUCTS Form' subtitle='Basic information' stage={2}
                backLink='/products-category-page'
                nextLink='/products-category-page/awesome/basic-information/photo-and-video'>
