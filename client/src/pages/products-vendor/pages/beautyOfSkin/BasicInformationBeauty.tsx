...
import styles from './BasicInformationBeauty.module.scss'
import {Layout} from "../../../../components/Vendor/Layout.tsx";

export const BasicInformationBeauty = () => {
    return(
        <Layout title='Beauty of Skin PRODUCTS Form' subtitle='Basic information' stage={2}
                backLink='/products-category-page'
                nextLink='/products-category-page/beauty/basic-information/photo-and-video'>
