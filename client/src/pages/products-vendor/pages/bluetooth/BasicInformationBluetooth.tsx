...
import styles from './BasicInformationBluetooth.module.scss'
import {Layout} from "../../../../components/Vendor/Layout.tsx";

export const BasicInformationBluetooth = () => {
    return(
        <Layout title='Bluetooth PRODUCTS Form' subtitle='Basic information' stage={2}
                backLink='/products-category-page'
                nextLink='/products-category-page/bluetooth/basic-information/photo-and-video'>
