...
import styles from './BasicInformationDiscover.module.scss'
import {Layout} from "../../../../components/Vendor/Layout.tsx";

export const BasicInformationDiscover = () => {
    return(
        <Layout title='Discover Skincare PRODUCTS Form' subtitle='Basic information' stage={2}
                backLink='/products-category-page'
                nextLink='/products-category-page/discover-skincare/basic-information/photo-and-video'>
