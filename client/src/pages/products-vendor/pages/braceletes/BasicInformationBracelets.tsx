...
import styles from './BasicInformationBracelets.module.scss'
import {Layout} from "../../../../components/Vendor/Layout.tsx";

export const BasicInformationBracelets = () => {
    return(
        <Layout title='Bracelets PRODUCTS Form' subtitle='Basic information' stage={2}
                backLink='/products-category-page'
                nextLink='/products-category-page/bracelets/basic-information/photo-and-video'>
