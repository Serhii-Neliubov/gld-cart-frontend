...
import styles from './BasicInformationHeadphones.module.scss'
import {Layout} from "../../../../components/Vendor/Layout.tsx";

export const BasicInformationHeadphones = () => {
    return(
        <Layout title='Headphones PRODUCTS Form' subtitle='Basic information' stage={2}
                backLink='/products-category-page'
                nextLink='/products-category-page/headphones/basic-information/photo-and-video'>
