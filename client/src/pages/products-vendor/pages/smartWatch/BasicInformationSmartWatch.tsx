...
import styles from './BasicInformationSmartWatch.module.scss'
import {Layout} from "../../../../components/Vendor/Layout.tsx";

export const BasicInformationSmartWatch = () => {
    return(
        <Layout title='Smart Watch PRODUCTS Form' subtitle='Basic information' stage={2}
                backLink='/products-category-page'
                nextLink='/products-category-page/smart-watch/basic-information/photo-and-video'>
