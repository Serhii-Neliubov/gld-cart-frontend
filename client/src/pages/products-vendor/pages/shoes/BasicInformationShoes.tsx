...
import styles from './BasicInformationShoes.module.scss'
import {Layout} from "../../../../components/Vendor/Layout.tsx";

export const BasicInformationShoes = () => {
    return(
        <Layout title='Shoes PRODUCTS Form' subtitle='Basic information' stage={2}
                backLink='/products-category-page'
                nextLink='/products-category-page/shoes/basic-information/photo-and-video'>
