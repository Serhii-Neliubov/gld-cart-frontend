...
import styles from './NewNecklaces.module.scss'
...
export const NewNecklaces = () => {
    ...
    return(
        <React.Fragment>
            {stage < 6 && <Layout setStage={setStage} title='Necklaces Renting Form' subtitle='Basic information' stage={stage - 1}>
                {stage == 3 &&
                    <React.Fragment>
            ...
            {stage == 6 && <ItemPublishPage category='Necklaces'/>}
        </React.Fragment>
    )
}