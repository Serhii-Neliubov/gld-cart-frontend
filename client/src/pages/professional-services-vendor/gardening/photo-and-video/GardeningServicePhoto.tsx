...
import styles from "./GardeningServicePhoto.module.scss";
import { Link } from "react-router-dom";

const GardeningServicePhoto: FC = () => {
  return (
    <div style={{ paddingBottom: "50px" }} className="__container">
      ...
      <div className={styles.actions}>
        ...
        <Link to="/renting-category-page/gardening/photo-and-video/specifications">
          <button
            style={{
...
export default GardeningServicePhoto;
