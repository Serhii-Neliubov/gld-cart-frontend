...
import styles from "./CleaningServiceSpecifications.module.scss";
import { Link } from "react-router-dom";

const CleaningServiceSpecifications: FC = () => {
  return (
    <div style={{ paddingBottom: "50px" }} className="__container">
      ...
      <div className={styles.actions}>
        ...
        <Link to="/personal-services/cleaning/photo-and-video/specifications/publishing">
          <button
            style={{
...
export default CleaningServiceSpecifications;
