...
import styles from "./RepairingServicePublishing.module.scss";
import { Link } from "react-router-dom";

const RepairingServicePublishing: FC = () => {
  return (
    <div
      style={{
        paddingBottom: "300px",
    ...
    >
      ...
      <div className={styles.content}>
        ...
        <h1 className={styles.title}>
          Your Repairing Renting Form has <br /> been Successfully Completed
        </h1>
...
export default RepairingServicePublishing;
