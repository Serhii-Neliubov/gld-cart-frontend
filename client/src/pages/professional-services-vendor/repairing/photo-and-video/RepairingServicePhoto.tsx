...
import styles from "./RepairingServicePhoto.module.scss";
import { Link } from "react-router-dom";

const RepairingServicePhoto: FC = () => {
  return (
    <div style={{ paddingBottom: "50px" }} className="__container">
      ...
      <div className={styles.actions}>
        ...
        <Link to="/renting-category-page/repairing/photo-and-video/specifications">
          <button
            style={{
...
export default RepairingServicePhoto;
