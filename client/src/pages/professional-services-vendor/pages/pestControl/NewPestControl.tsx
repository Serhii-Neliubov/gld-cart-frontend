...
export const NewPestControl = () => {
    ...
    return(
        <React.Fragment>
            {stage < 6 && <Layout setStage={setStage} title='Pest Control Renting Form' subtitle='Basic information' stage={stage - 1}>
                {stage == 3 &&
                    <React.Fragment>
            ...
            {stage == 6 && <ItemPublishPage category='Pest Control'/>}
        </React.Fragment>
    )
}