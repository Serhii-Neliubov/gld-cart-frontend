...
import styles from './PhotoAndVideoCleaning.module.scss'
import {Layout} from "../../../../components/Vendor/Layout.tsx";

export const PhotoAndVideoCleaning = () => {
    return (
        <Layout title='Cleaning SERVICES Form ' subtitle='Photo and video' nextLink='/professional-services/cleaning/basic-information/photo-and-video/specifications' backLink='/professional-services/cleaning/basic-information' stage={3}>
