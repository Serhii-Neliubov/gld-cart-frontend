...
import styles from './PhotoAndVideoLawn.module.scss'
import {Layout} from "../../../../components/Vendor/Layout.tsx";

export const PhotoAndVideoLawn = () => {
    return (
        <Layout title='Lawn SERVICES Form' subtitle='Photo and video' nextLink='/professional-services/lawn-services/basic-information/photo-and-video/specifications' backLink='/professional-services/lawn-services/basic-information' stage={3}>
