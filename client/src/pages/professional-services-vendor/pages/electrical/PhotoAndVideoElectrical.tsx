...
import styles from './PhotoAndVideoElectrical.module.scss'
import {Layout} from "../../../../components/Vendor/Layout.tsx";

export const PhotoAndVideoElectrical = () => {
    return (
        <Layout title='Electrical SERVICES Form' subtitle='Photo and video' nextLink='/professional-services/electrical/basic-information/photo-and-video/specifications' backLink='/professional-services/electrical/basic-information' stage={3}>
