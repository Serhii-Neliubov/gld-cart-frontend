...
export const NewSnowRemoval = () => {
    ...
    return(
        <React.Fragment>
            {stage < 6 && <Layout setStage={setStage} title='Snow Removal Renting Form' subtitle='Basic information' stage={stage - 1}>
                {stage == 3 &&
                    <React.Fragment>
            ...
            {stage == 6 && <ItemPublishPage category='Snow Removal'/>}
        </React.Fragment>
    )
}