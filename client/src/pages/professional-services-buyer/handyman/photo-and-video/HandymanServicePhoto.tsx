...
import styles from "./HandymanServicePhoto.module.scss";
import { Link } from "react-router-dom";

const HandymanServicePhoto: FC = () => {
  return (
    <div style={{ paddingBottom: "50px" }} className="__container">
      ...
      <div className={styles.actions}>
        ...
        <Link to="/renting-category-page/handyman/photo-and-video/specifications">
          <button
            style={{
...
export default HandymanServicePhoto;
