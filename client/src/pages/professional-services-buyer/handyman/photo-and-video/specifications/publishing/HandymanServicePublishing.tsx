...
import styles from "./HandymanServicePublishing.module.scss";
import { Link } from "react-router-dom";

const HandymanServicePublishing: FC = () => {
  return (
    <div
      style={{
        paddingBottom: "300px",
    ...
    >
      ...
      <div className={styles.content}>
        ...
        <h1 className={styles.title}>
          Your Handyman Renting Form has <br /> been Successfully Completed
        </h1>
...
export default HandymanServicePublishing;
