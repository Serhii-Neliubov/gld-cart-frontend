...
import styles from "./SnowRemovalServicePublishing.module.scss";
import { Link } from "react-router-dom";

const SnowRemovalServicePublishing: FC = () => {
  return (
    <div
      style={{
        paddingBottom: "300px",
    ...
    >
      ...
      <div className={styles.content}>
        ...
        <h1 className={styles.title}>
          Your Snow Removal Renting Form has <br /> been Successfully Completed
        </h1>
...
export default SnowRemovalServicePublishing;
