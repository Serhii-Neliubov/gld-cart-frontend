...
import styles from "./SnowRemovalServicePhoto.module.scss";
import { Link } from "react-router-dom";

const SnowRemovalServicePhoto: FC = () => {
  return (
    <div style={{ paddingBottom: "50px" }} className="__container">
      ...
      <div className={styles.actions}>
        ...
        <Link to="/renting-category-page/snow-removal/photo-and-video/specifications">
          <button
            style={{
...
export default SnowRemovalServicePhoto;
