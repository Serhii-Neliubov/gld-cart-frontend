...
import styles from "./PestControlServiceSpecifications.module.scss";
import { Link } from "react-router-dom";

const PestControlServiceSpecifications: FC = () => {
  return (
...
export default PestControlServiceSpecifications;
