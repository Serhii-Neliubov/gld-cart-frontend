...
import styles from './DiscoverSkincare.module.scss';
import Footer from '../../../../components/Footer/Footer';

export const DiscoverSkincare = () => {
    return (
        <React.Fragment>
            <div className='__container'>
                <div className={styles.content}>
                            ...
                            <div className={styles.topRatedProducts}>
                                ...
                                <div className={styles.topRatedProductsItems}>
                                    <div className={styles.topRatedProductsItem}>
                                        <img src='/TopRatedProducts/headphones.png' alt='img'/>
                                        <div>
                                    ...
                                    <div className={styles.topRatedProductsItem}>
                                        <img src='/TopRatedProducts/iphone12.png' alt='img'/>
                                        <div>
                                            <div className={styles.rating}>(rating)</div>
                                    ...
                                    <div className={styles.topRatedProductsItem}>
                                        <img src='/TopRatedProducts/appleWatch.png' alt='img'/>
                                        <div>
                                            <div className={styles.rating}>(rating)</div>
                            ...
                            <div className={styles.popularBrands}>
                                ...
                                <div className={styles.popularBrandsItems}>
                                    <div className={styles.popularBrandsColumn}>
                                        <img src='/TopRatedProducts/img1.png' alt=''/>
                                        <img src='/TopRatedProducts/img2.png' alt=''/>
                                        <img src='/TopRatedProducts/img3.png' alt=''/>
                                    </div>
                                    <div className={styles.popularBrandsColumn}>
                                        <img src='/TopRatedProducts/img4.png' alt=''/>
                                        <img src='/TopRatedProducts/img5.png' alt=''/>
                                        <img src='/TopRatedProducts/img6.png' alt=''/>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className={styles.products}>
                        <span className={styles.productsTitle}>Discover Skincare</span>
                        <div className={styles.actionButtons}>
                            <div>
                                <button className={styles.defaultSortButton}>
                                    <img src='/TopRatedProducts/defaultIcon.svg' alt=''/>
                                </button>
                                <button className={styles.menuSortButton}>
                                    <img src='/TopRatedProducts/menuSort.svg' alt=''/>
                                </button>
                            </div>
                            ...
                            <div>
                                ...
                                <button className={styles.filterButton}>
                                    <img src='/TopRatedProducts/filterIcon.svg' alt=''/>
                                    Filter
                                </button>
                            </div>
                        </div>
