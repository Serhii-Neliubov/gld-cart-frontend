...
import styles from "./LawnServicePhoto.module.scss";
import { Link } from "react-router-dom";

const LawnServicePhoto: FC = () => {
  return (
    <div style={{ paddingBottom: "50px" }} className="__container">
      ...
      <div className={styles.actions}>
        ...
        <Link to="/renting-category-page/lawn/photo-and-video/specifications">
          <button
            style={{
...
export default LawnServicePhoto;
