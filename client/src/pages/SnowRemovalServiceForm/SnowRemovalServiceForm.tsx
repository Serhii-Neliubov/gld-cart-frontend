...
import styles from "./SnowRemovalServiceForm.module.scss";
import { Link } from "react-router-dom";

const SnowRemovalServiceForm: FC = () => {
  return (
    <div style={{ paddingBottom: "50px" }} className="__container">
          ...
          <div style={{ marginTop: "35px" }}>
            <div style={{ display: "flex", gap: "100px" }}>
              <div style={{ display: "flex", gap: "10px" }}>
                ...
                <span style={{ fontWeight: "600" }}>
                  Snow Removal Packages For Hour
                </span>
              </div>
              <div style={{ display: "flex", gap: "10px" }}>
                <input style={{ width: "20px" }} type="checkbox" />
                <span style={{ fontWeight: "600" }}>
                  Snow Removal Packages For Day
                </span>
              </div>
              <div style={{ display: "flex", gap: "10px" }}>
                <input style={{ width: "20px" }} type="checkbox" />
                <span style={{ fontWeight: "600" }}>
                  Snow Removal Packages For week
                </span>
              </div>
            </div>
            <div
      ...
      <div className={styles.actions}>
        ...
        <Link to="/personal-services/snow-removal/photo-and-video">
          <button
            style={{
...
export default SnowRemovalServiceForm;
