...
import styles from "./GardeningServiceSpecifications.module.scss";
import { Link } from "react-router-dom";

const GardeningServiceSpecifications: FC = () => {
  return (
    <div style={{ paddingBottom: "50px" }} className="__container">
      ...
      <div className={styles.content}>
        ...
        <div>
          <span className={styles.content_driver}>
            Need Safety Material For Tree Cutting
          </span>
          <div
            style={{ display: "flex", gap: "20px", margin: "10px 0px 50px 0" }}
          >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
          <span style={{ fontWeight: 600 }}>Select type of tree cutting</span>
      ...
      <div className={styles.actions}>
        ...
        <Link to="/renting-category-page/tree-cutting/photo-and-video/specifications/publishing">
          <button
            style={{
...
export default GardeningServiceSpecifications;
