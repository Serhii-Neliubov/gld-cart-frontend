...
import styles from "./RepairingServiceForm.module.scss";
import { Link } from "react-router-dom";

const RepairingServiceForm: FC = () => {
  return (
    <div style={{ paddingBottom: "50px" }} className="__container">
      ...
      <h1 className={styles.title}>Repairing SERVICES Form</h1>
      <div className={styles.content}>
        ...
        <div className={styles.content_input_radio}>
          <span style={{ fontWeight: 600 }}>
            You want to give your professional service in{" "}
          </span>
          <div style={{ display: "flex", gap: "20px", alignItems: "center" }}>
            <input style={{ width: "20px", height: "20px" }} type="radio" />
            <label htmlFor="input">At Home</label>
            <input style={{ width: "20px", height: "20px" }} type="radio" />
            <label htmlFor="input">At Shop</label>
          </div>
        </div>
        <div>
          ...
          <div style={{ marginTop: "35px" }}>
            <div style={{ display: "flex", gap: "100px" }}>
              <div style={{ display: "flex", gap: "10px" }}>
                ...
                <span style={{ fontWeight: "600" }}>
                  Repairing Packages For Product
                </span>
              </div>
              <div style={{ display: "flex", gap: "10px" }}>
                <input style={{ width: "20px" }} type="checkbox" />
                <span style={{ fontWeight: "600" }}>Fix Price Repairing</span>
              </div>
            </div>
            <div
              style={{
            ...
            >
              ...
              <div style={{ display: "flex", gap: "20px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                  ...
                  >
                    <option value="volvo">Per Product</option>
                  </select>
                </div>
              </div>
            </div>
      ...
      <div className={styles.actions}>
        ...
        <Link to="/personal-services/repairing/photo-and-video">
          <button
            style={{
